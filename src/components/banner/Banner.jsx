    ...
    return (
        <div className='mb-4 md:mb-8 lg:mb-12'>
            <div className='relative'>
                ...
                <h2 className='text-white drop-shadow-lg font-extrabold text-xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl md:text-left inline-block w-1/2 2xl:w-1/3 left-4 md:left-8 text absolute top-20 md:top-1/3 lg:top-[30%] space z-10 '>
